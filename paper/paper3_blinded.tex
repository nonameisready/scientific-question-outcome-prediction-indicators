...
the community to reuse, audit, and extend to other sciences; an
extension to a second domain with harder outcome signals is in
preparation (clinical oncology, where trial registrations and phase
transitions are observable events rather than retrieval-bounded
labels). A
forward-looking test is already armed: the frozen prospective
instance of~\cite{paper2} --- 200 questions from four generators, frozen 2026-08-17 with
...
Referred to as ``\cite{paper1}'' throughout.
...
Referred to as ``\cite{paper2}'' throughout.
